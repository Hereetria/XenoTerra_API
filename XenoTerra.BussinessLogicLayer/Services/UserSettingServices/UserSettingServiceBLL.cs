...
{
     public class UserSettingServiceBLL : GenericRepositoryBLL<UserSetting, ResultUserSettingDto, CreateUserSettingDto, UpdateUserSettingDto, Guid>, IUserSettingServiceBLL
    {
