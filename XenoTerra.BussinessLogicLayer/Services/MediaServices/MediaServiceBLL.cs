...
{
     public class MediaServiceBLL : GenericRepositoryBLL<Media, ResultMediaDto, ResultMediaWithRelationsDto, CreateMediaDto, UpdateMediaDto, Guid>, IMediaServiceBLL
    {
