...
{
     public class ReactionServiceBLL : GenericRepositoryBLL<Reaction, ResultReactionDto, ResultReactionByIdDto, CreateReactionDto, UpdateReactionDto, Guid>, IReactionServiceBLL
    {
