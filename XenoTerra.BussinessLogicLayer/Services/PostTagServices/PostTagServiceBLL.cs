...
{
     public class PostTagServiceBLL : GenericRepositoryBLL<PostTag, ResultPostTagDto, ResultPostTagWithRelationsDto, CreatePostTagDto, UpdatePostTagDto, Guid>, IPostTagServiceBLL
    {
