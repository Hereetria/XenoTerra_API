...
namespace XenoTerra.BussinessLogicLayer.Services.Entity.StoryService
{
    ...
    {
        public StoryReadService(IReadRepository<Story, Guid> repository, IMapper mapper, SelectorExpressionProvider<Story, ResultStoryWithRelationsDto> selectorExpressionProvider)
