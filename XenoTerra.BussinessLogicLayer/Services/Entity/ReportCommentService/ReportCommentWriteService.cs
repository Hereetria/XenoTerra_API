...
namespace XenoTerra.BussinessLogicLayer.Services.Entity.ReportCommentService
{
    ...
    {
        public ReportCommentWriteService(IWriteRepository<ReportComment, Guid> repository, IMapper mapper, SelectorExpressionProvider<ReportComment, ResultReportCommentDto> selectorExpressionProvider)
