...
namespace XenoTerra.BussinessLogicLayer.Services.Entity.ReactionService
{
    ...
    {
        public ReactionWriteService(IWriteRepository<Reaction, Guid> repository, IMapper mapper, SelectorExpressionProvider<Reaction, ResultReactionDto> selectorExpressionProvider)
