...
{
     public class CommentServiceBLL : GenericRepositoryBLL<Comment, ResultCommentDto, ResultCommentByIdDto, CreateCommentDto, UpdateCommentDto, Guid>, ICommentServiceBLL
    {
