...
{
     public class StoryServiceBLL : GenericRepositoryBLL<Story, ResultStoryDto, ResultStoryWithRelationsDto, CreateStoryDto, UpdateStoryDto, Guid>, IStoryServiceBLL
    {
