...
{
     public class BlockUserServiceBLL : GenericRepositoryBLL<BlockUser, ResultBlockUserDto, ResultBlockUserWithRelationsDto, CreateBlockUserDto, UpdateBlockUserDto, Guid>, IBlockUserServiceBLL
    {
