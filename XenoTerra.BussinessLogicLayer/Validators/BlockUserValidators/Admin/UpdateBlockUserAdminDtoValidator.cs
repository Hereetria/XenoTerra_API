...
{
    public class UpdateBlockUserAdminDtoValidator : AbstractValidator<UpdateBlockUserAdminDto>
    {
        public UpdateBlockUserAdminDtoValidator(IExistenceChecker<BlockUser, UpdateBlockUserAdminDto> existenceChecker)
        {
