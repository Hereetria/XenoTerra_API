...
{
    public class UpdateReportCommentDtoValidator : AbstractValidator<UpdateReportCommentDto>
    {
        public UpdateReportCommentDtoValidator()
        {
            RuleFor(x => x.ReportCommentId)
                .NotEmpty()
                .WithMessage("ReportCommentId must not be empty.");
