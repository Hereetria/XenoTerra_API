...
{
    public class CreateStoryLikeAdminDtoValidator : AbstractValidator<CreateStoryLikeAdminDto>
    {
        public CreateStoryLikeAdminDtoValidator(IExistenceChecker<StoryLike, CreateStoryLikeAdminDto> existenceChecker)
        {
            RuleFor(x => x.StoryId)
                .NotEqual(Guid.Empty)
