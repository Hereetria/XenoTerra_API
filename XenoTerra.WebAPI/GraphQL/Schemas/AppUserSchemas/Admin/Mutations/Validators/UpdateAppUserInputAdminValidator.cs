...
namespace XenoTerra.WebAPI.GraphQL.Schemas.AppUserSchemas.Admin.Mutations.Validators
{
    public class UpdateUserInputAdminValidator : AbstractValidator<UpdateUserAdminInput>
    {
        public UpdateUserInputAdminValidator()
        {
            RuleFor(x => x.Id)
