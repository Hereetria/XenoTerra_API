...
namespace XenoTerra.WebAPI.GraphQL.Schemas.AppUserSchemas.Self.Queries
{
    ...
    public class AppUserOwnOwnQuery(IMapper mapper, IQueryResolverHelper<AppUser, Guid> queryResolver)
    {
        ...
        public async Task<AppUserOwnOwnConnection> GetAllUsersAsync(
            ...
            IResolverContext context)
        {
            ...
            return GraphQLConnectionFactory.Create<AppUserOwnOwnConnection, ResultAppUserWithRelationsOwnDto>(connection);
        }

        [UseCustomPaging]
        [UseFiltering(typeof(AppUserFilterType))]
        [UseSorting(typeof(AppUserSortType))]
        public async Task<AppUserOwnOwnConnection> GetUsersByIdsAsync(
