...
{
    public class StoryChangedEventType : ObjectType<StoryChangedSelfEvent>
    {
        protected override void Configure(IObjectTypeDescriptor<StoryChangedSelfEvent> descriptor)
        {
        }
    }
}