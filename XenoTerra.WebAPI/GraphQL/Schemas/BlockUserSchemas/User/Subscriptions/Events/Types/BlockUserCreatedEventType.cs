...
{
    public class BlockUserCreatedEventType : ObjectType<BlockUserCreatedSelfEvent>
    {
        protected override void Configure(IObjectTypeDescriptor<BlockUserCreatedSelfEvent> descriptor)
        {
        }
    }
}
