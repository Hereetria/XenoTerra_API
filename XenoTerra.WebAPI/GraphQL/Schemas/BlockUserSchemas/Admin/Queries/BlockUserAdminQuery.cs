...
namespace XenoTerra.WebAPI.GraphQL.Schemas.BlockUserSchemas.Admin.Queries
{
    ...
    public class BlockUserAdminQuery(IMapper mapper, IQueryResolverHelper<BlockUser, Guid> queryResolver)
    {
            ...
            IResolverContext context)
        {
            ...
            var connection = ConnectionMapper.MapConnection<BlockUser, ResultBlockUserWithRelationsAdminDto>(
                entityAdminConnection,
                _mapper
            );

            return GraphQLConnectionFactory.Create<BlockUserAdminConnection, ResultBlockUserWithRelationsAdminDto>(connection);
        }
        ...
        public async Task<ResultBlockUserWithRelationsAdminDto?> GetBlockUserByIdAsync(
            string? key,
            [Service] IBlockUserQueryService service,
            [Service] IBlockUserResolver resolver,
            IResolverContext context)
        {
            ...
            return entity is null ? null : _mapper.Map<ResultBlockUserWithRelationsAdminDto>(entity);
        }
    }
}
