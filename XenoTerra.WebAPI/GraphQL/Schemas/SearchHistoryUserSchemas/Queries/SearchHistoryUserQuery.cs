...
using XenoTerra.WebAPI.GraphQL.Schemas.SearchHistoryUserSchemas.Queries.Filters;
using XenoTerra.WebAPI.GraphQL.Schemas.SearchHistoryUserSchemas.Queries.Paginations;
using XenoTerra.WebAPI.GraphQL.Schemas.SearchHistoryUserSchemas.Queries.Sorts;
using XenoTerra.WebAPI.Helpers;
using XenoTerra.WebAPI.Services.Queries.Entity.SearchHistoryUserQueryServices;

namespace XenoTerra.WebAPI.GraphQL.Schemas.SearchHistoryUserSchemas.Queries
{
