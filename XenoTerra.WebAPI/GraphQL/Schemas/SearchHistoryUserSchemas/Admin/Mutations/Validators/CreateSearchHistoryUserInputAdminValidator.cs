...
{
    public class CreateSearchHistoryUserInputAdminValidator : AbstractValidator<CreateSearchHistoryUserAdminInput>
    {
        public CreateSearchHistoryUserInputAdminValidator()
        {
