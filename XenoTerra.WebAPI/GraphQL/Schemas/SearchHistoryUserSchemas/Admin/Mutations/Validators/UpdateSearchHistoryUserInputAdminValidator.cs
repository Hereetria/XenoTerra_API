...
{
    public class UpdateSearchHistoryUserInputAdminValidator : AbstractValidator<UpdateSearchHistoryUserAdminInput>
    {
        public UpdateSearchHistoryUserInputAdminValidator()
        {
