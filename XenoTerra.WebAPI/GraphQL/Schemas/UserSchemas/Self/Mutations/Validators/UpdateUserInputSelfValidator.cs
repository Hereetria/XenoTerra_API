...
namespace XenoTerra.WebAPI.GraphQL.Schemas.UserSchemas.Self.Mutations.Validators
{
    public class UpdateUserInputSelfValidator : AbstractValidator<UpdateUserSelfInput>
    {
        public UpdateUserInputSelfValidator()
        {
            RuleFor(x => x.Id)
