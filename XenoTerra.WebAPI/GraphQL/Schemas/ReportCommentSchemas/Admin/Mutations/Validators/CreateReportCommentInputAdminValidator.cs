...
namespace XenoTerra.WebAPI.GraphQL.Schemas.ReportCommentSchemas.Admin.Mutations.Validators
{
    public class CreateReportCommentInputAdminValidator : AbstractValidator<CreateReportCommentAdminInput>
    {
        public CreateReportCommentInputAdminValidator()
        {
