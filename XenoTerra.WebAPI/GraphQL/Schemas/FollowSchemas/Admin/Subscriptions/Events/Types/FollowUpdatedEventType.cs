...
{
    public class FollowUpdatedEventType : ObjectType<FollowUpdatedAdminEvent>
    {
        protected override void Configure(IObjectTypeDescriptor<FollowUpdatedAdminEvent> descriptor)
        {
        }
    }
}
