...
{
    public class MessageDeletedEventType : ObjectType<MessageDeletedAdminEvent>
    {
        protected override void Configure(IObjectTypeDescriptor<MessageDeletedAdminEvent> descriptor)
        {
        }
    }
}
