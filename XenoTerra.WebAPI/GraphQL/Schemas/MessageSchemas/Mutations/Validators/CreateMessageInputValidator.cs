...
namespace XenoTerra.WebAPI.GraphQL.Schemas.MessageSchemas.Mutations.Validators
{
    public class CreateMessageInputValidator : AbstractValidator<CreateMessageInput>
    {
        public CreateMessageInputValidator()
        {
            RuleFor(x => x.Content)
