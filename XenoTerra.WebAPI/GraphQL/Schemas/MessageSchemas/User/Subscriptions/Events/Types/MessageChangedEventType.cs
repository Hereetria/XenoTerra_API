...
{
    public class MessageChangedEventType : ObjectType<MessageChangedSelfEvent>
    {
        protected override void Configure(IObjectTypeDescriptor<MessageChangedSelfEvent> descriptor)
        {
        }
    }
}
