    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecentChatsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecentChatses", x => x.RecentChatsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockUsers", x => x.BlockUserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecentChatsUser", x => new { x.RecentChatsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_RecentChatsUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecentChatsUser_RecentChatses_RecentChatsId",
                        column: x => x.RecentChatsId,
                        principalTable: "RecentChatses",
                        principalColumn: "RecentChatsId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostTag", x => new { x.PostId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchHistoryUser", x => new { x.SearchHistoryId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ViewStoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewStories", x => x.ViewStoryId);
                    table.ForeignKey(
                        name: "FK_ViewStories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ViewStories_Stories_StoryId",
                        column: x => x.StoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReportCommentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportComments", x => x.ReportCommentId);
                    table.ForeignKey(
                        name: "FK_ReportComments_AspNetUsers_ReporterUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockUsers_BlockingUserId",
                table: "BlockUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecentChatsUser_UsersId",
                table: "RecentChatsUser",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportComments_ReporterUserId",
                table: "ReportComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViewStories_StoryId",
                table: "ViewStories",
                column: "StoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ViewStories_UserId",
                table: "ViewStories",
                column: "UserId");
        }
